...
exports.LargeScaleFileSearcher = void 0;
exports.runFileSearchExamples = runFileSearchExamples;
...
class LargeScaleFileSearcher {
    ...
    async searchText(pattern, searchDirectory = '.', options = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const rg = (0, child_process_1.spawn)(this.rgPath, args);
            let output = '';
            let error = '';
...
exports.LargeScaleFileSearcher = LargeScaleFileSearcher;
/**
 * 示例使用函数
 */
...
exports.default = LargeScaleFileSearcher;
